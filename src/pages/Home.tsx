...
import { CartContext } from '../context/CartContext'; // Añadir este import
...
const Home: React.FC = () => {
  ...
  const { addToCart } = useContext(CartContext); // Añadir en la parte superior con los otros contextos
